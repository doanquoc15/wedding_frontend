        ...
        <div className="min-w-[500px] h-auto p-6 relative">
          <div>
            ...
            <div
              ...
              <div className="flex"><p className="min-w-[200px]">Tổng tiền món
                ăn</p> {formatMoney(booking?.comboMenu?.totalPrice)} VND
              </div>
              <div className="flex"><p className="min-w-[200px]">Tổng tiền dịch
                vụ</p> {formatMoney(booking?.comboMenu?.service?.price)} VND
              </div>
              ...
              <div className="flex"><p className="min-w-[200px]">Tổng
                tiền:</p> {formatMoney(calculatorPrice(booking))} VND
              </div>
              <div className="flex mt-5"><p className="min-w-[200px]">Tiền
                cọc:</p> {formatMoney(calculatorPrice(booking) * 15 / 100)} VND
              </div>
