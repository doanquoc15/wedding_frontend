...
const PendingPage = () => {
  return (
    <div className="flex flex-col gap-[3px] shadow-[1px_3px-5px_red]">
      ...
      <div
        className="rrounded-t-[6px] p-4 bg-[--clr-orange-50] text-[13px] text-[--clr-gray-500] flex justify-between w-full items-center">
        <span className="italic">Chỉ được hủy lịch trước ngày <span
          className="text-[--clr-red-300]">12/4/2023</span></span>
        <ButtonBtn width={150} bg="var(--clr-red-400)" onClick={() => {
        }}>Hủy đơn hàng</ButtonBtn>
      </div>
    </div>
  );
};
